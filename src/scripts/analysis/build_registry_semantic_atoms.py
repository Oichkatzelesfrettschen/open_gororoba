#!/usr/bin/env python3
"""
Build canonical semantic-atoms lane strict TOML registries.

Canonical semantic-atoms lane mapping:
...
def _render_claim_atoms(rows: list[dict]) -> str:
    lines = [
        "# Claim atoms registry (semantic-atoms lane strict schema).",
        "# Generated by src/scripts/analysis/build_registry_semantic_atoms.py.",
        "",
        "[claims_atoms]",
...
def _render_claim_edges(rows: list[dict]) -> str:
    lines = [
        "# Claim evidence edge registry (semantic-atoms lane strict schema).",
        "# Generated by src/scripts/analysis/build_registry_semantic_atoms.py.",
        "",
...
def _render_equation_atoms_v2(rows: list[dict]) -> str:
    lines = [
        "# Equation atoms v2 registry (semantic-atoms lane strict schema).",
        "# Generated by src/scripts/analysis/build_registry_semantic_atoms.py.",
        "",
...
def _render_symbol_table(rows: list[dict]) -> str:
    lines = [
        "# Equation symbol table (semantic-atoms lane strict schema).",
        "# Generated by src/scripts/analysis/build_registry_semantic_atoms.py.",
        "",
...
def _render_proof_skeletons(rows: list[dict]) -> str:
    lines = [
        "# Proof skeleton registry (semantic-atoms lane strict schema).",
        "# Generated by src/scripts/analysis/build_registry_semantic_atoms.py.",
        "",
...
def main() -> int:
    ...
    print(
        "Wrote semantic-atoms registry lane artifacts: "
