#!/usr/bin/env python3
"""
Build canonical integrity-resolution lane strict TOML registries.

Deprecated legacy alias:
- src/scripts/analysis/build_wave5_batch3_registries.py

Legacy Wave 5 Batch 3 mapping:
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Build canonical integrity-resolution lane registries. "
            "Deprecated legacy alias: src/scripts/analysis/build_wave5_batch3_registries.py."
        )
    )
    parser.add_argument(
        "--repo-root",
