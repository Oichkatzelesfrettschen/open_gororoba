#!/usr/bin/env python3
"""
Build canonical evidence-provenance lane strict TOML registries.
...
def _render_derivation_steps(rows: list[dict], meta: dict) -> str:
    lines: list[str] = []
    lines.append("# Derivation step registry (evidence-provenance lane strict schema; legacy Wave 5 Batch 2 compatibility).")
...
def _render_bibliography_normalized(rows: list[dict], meta: dict) -> str:
    lines: list[str] = []
    lines.append("# Normalized bibliography registry (evidence-provenance lane strict schema; legacy Wave 5 Batch 2 compatibility).")
    lines.append("# Generated by src/scripts/analysis/build_wave5_batch2_registries.py.")
    lines.append("")
...
def _render_provenance_sources(rows: list[dict], meta: dict) -> str:
    lines: list[str] = []
    lines.append("# Provenance source registry (evidence-provenance lane strict schema; legacy Wave 5 Batch 2 compatibility).")
    lines.append("# Generated by src/scripts/analysis/build_wave5_batch2_registries.py.")
    lines.append("")
...
def _render_narrative_paragraph_atoms(rows: list[dict], meta: dict) -> str:
    lines: list[str] = []
    lines.append("# Narrative paragraph atom registry (evidence-provenance lane strict schema; legacy Wave 5 Batch 2 compatibility).")
    lines.append("# Generated by src/scripts/analysis/build_wave5_batch2_registries.py.")
    lines.append("")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build canonical evidence-provenance lane registries."
    )
    parser.add_argument(
        "--repo-root",
    ...
    print(
        "Wrote canonical evidence-provenance registries: "
