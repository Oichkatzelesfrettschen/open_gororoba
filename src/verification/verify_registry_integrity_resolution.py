#!/usr/bin/env python3
"""
Verify canonical integrity-resolution lane registries.

Deprecated legacy alias:
- src/verification/verify_wave5_batch3_registries.py

Legacy Wave 5 Batch 3 registry set:
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Verify canonical integrity-resolution lane registries. "
            "Deprecated legacy alias: src/verification/verify_wave5_batch3_registries.py."
        )
    )
    parser.add_argument(
        "--repo-root",
    ...
    if failures:
        print("ERROR: integrity-resolution registry lane verification failed (canonical registry-integrity-resolution script).")
    ...
    print(
        "OK: integrity-resolution registry lane verified (canonical registry-integrity-resolution script). "
