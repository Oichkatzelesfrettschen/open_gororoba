#!/usr/bin/env python3
"""
Verify canonical evidence-provenance lane registries.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Verify canonical evidence-provenance lane registries."
    )
    parser.add_argument(
        "--repo-root",
    ...
    if failures:
        print("ERROR: canonical evidence-provenance registry verification failed.")
    ...
    print(
        "OK: canonical evidence-provenance registries verified. "
