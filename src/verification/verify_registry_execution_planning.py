#!/usr/bin/env python3
"""
Verify canonical execution-planning lane registries.

Compatibility note:
- Canonical script: src/verification/verify_registry_execution_planning.py
- Legacy script name retained for deprecated wave5-batch4 aliases

Legacy Wave 5 Batch 4 registry set:
...
def main() -> int:
    ...
    # Execution-planning lane: W5-016 legacy row (experiments normalization).
    ...
    # Execution-planning lane: W5-022 legacy row (requirements decomposition).
