//! Fetch logic for Solar Orbiter RPW BIA spacecraft-potential data.
//!
//! Parse logic and record types live in `solar_orbiter_rpw`.

use super::solar_orbiter_rpw::{
    ScalarAccumulator, SolarOrbiterRpwRecord, parse_solar_orbiter_rpw_hapi_csv,
};
use crate::{
