//! Fetch logic for IMAP public-product staging providers.
//!
//! Parse logic, record types, and pure helper functions live in `imap`.

use super::imap::{
    IalirtAccumulator, ImapHelio1hrRecord, ImapHiH90Summary, ImapIalirtRecord, iso_time_to_ydh,
    json_f64, json_vec_f64, km_xyz_to_spherical_au, mean, rows_from_accumulator, sanitize_numeric,
    stddev,
};
use crate::{
    cdf_support::{
