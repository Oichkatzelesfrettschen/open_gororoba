...
/// Base URL for WIND SWE KP unspiked (annual files).
...
//
// Lane:
//   1. SPDF direct ASC download (existing WindMfiProvider / WindSweProvider).
...
/// AMDA dataset ID for WIND SWE KP plasma moments.
const WIND_AMDA_SWE: &str = "wnd-swe-kp";

/// AMDA dataset ID for WIND MFI KP hourly magnetic field.
