...
// Parameter lookup + step-size + prior-sigma helpers, plus
// selector / tagged-term observation matchers, plus FD profile
// delay, solar-system Shapiro delay, and the EFAC/EQUAD/DMEFAC
// effective-sigma calculators. Live in the `parameters` submodule.
mod parameters;
use parameters::{
