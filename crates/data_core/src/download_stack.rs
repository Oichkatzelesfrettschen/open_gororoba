...
// Per-host rate limiter lives in the `rate_limiter` submodule.
// Re-export keeps the public API at data_core::download_stack::RateLimiter.
mod rate_limiter;
...
// Host-routing policy registry: load_host_policy_registry parses the
