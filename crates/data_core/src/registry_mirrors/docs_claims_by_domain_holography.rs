...
//!   - Where stated: `docs/external_sources/CAYLEY_DICKSON_BASICS_SOURCES.md`, `src/verification/verify_algebra.py`, `tests/test_cayley_dickson_properties.py`
//!
//! - Hypothesis C-002 (Verified (math), 2026-02-02): 16D sedenions have zero divisors and lose norm composition.
//!   - Where stated: `docs/THE_GEMINI_PROTOCOL.md`, `docs/external_sources/CAYLEY_DICKSON_BASICS_SOURCES.md`, `docs/external_sources/DE_MARRAIS_SOURCES.md`, `tests/test_cayley_dickson_properties.py`
//!
...
//!   - Where stated: `data/csv/surreal_cd_ordinal_mapping.csv`, `docs/theory/unified_tensor_wheel_cd_framework.md`, `src/scripts/analysis/surreal_cd_ordinal_construction.py`, `tests/test_surreal_cd_ordinal.py`
//!
...
//!   - Where stated: `crates/algebra_analysis/src/grassmannian.rs`, `crates/stats_core/src/claims_gates.rs`, `data/csv/deff_horizon_mass_scaling_summary.csv`, `docs/C027_DEFF_HORIZON_TEST.md`, `docs/external_sources/C027_EFFECTIVE_DIMENSION_SOURCES.md`, `docs/stellar_cartography/theory/ONTOLOGICAL_AXIOMS.md`, `src/scripts/analysis/deff_horizon_mass_scaling.py`, `tests/test_c027_deff_horizon_mass_scaling.py`
//!
...
//!   - Where stated: `data/csv/c031_hurwitz_norm_composition_checks.csv`, `docs/C030_SEDENION_LAGRANGIAN_BYPASS.md`, `docs/SEDENION_FIELD_THEORY.md`, `docs/convos/pdf_extract_3f6ee1e837d1_sedenion_valued_field_theories_action_principles_and_challenges.md`, `docs/external_sources/C031_HURWITZ_QUANTIZATION_SOURCES.md`, `src/scripts/analysis/c031_hurwitz_norm_composition_checks.py`, `tests/test_c031_hurwitz_norm_composition_checks.py`
//!
...
//!   - Where stated: `crates/cosmology_core/src/spectral.rs`, `data/csv/c039_spectral_dimension_bigraph_curve.csv`, `data/csv/c039_spectral_dimension_bigraph_summary.csv`, `docs/convos/pdf_extract_2b693d92f57d_exceptional_cosmological_framework_synthesis.md`, `docs/external_sources/EXCEPTIONAL_COSMOLOGY_SOURCES.md`, `src/scripts/analysis/c039_spectral_dimension_bigraph_sweep.py`, `tests/test_c039_spectral_dimension_bigraph_artifacts.py`, `tests/test_spectral_dimension.py`
//!
...
//!   - Where stated: `crates/cosmology_core/src/spectral.rs`, `data/csv/c040_primordial_tilt_deff_curve.csv`, `data/csv/c040_primordial_tilt_summary.csv`, `docs/EXCEPTIONAL_COSMOLOGY.md`, `docs/convos/pdf_extract_2b693d92f57d_exceptional_cosmological_framework_synthesis.md`, `docs/external_sources/EXCEPTIONAL_COSMOLOGY_SOURCES.md`, `src/scripts/analysis/c040_primordial_tilt_deff_sweep.py`, `tests/test_c040_primordial_tilt_artifacts.py`, `tests/test_primordial_tilt.py`
//!
...
//!   - Where stated: `data/csv/compact_objects_catalog.PROVENANCE.json`, `data/csv/compact_objects_catalog.csv`, `docs/ROADMAP_DETAILED.md`, `docs/external_sources/C043_COMPACT_OBJECT_CATALOG_SOURCES.md`, `src/scripts/data/fetch_atnf_pulsars_full.py`, `src/scripts/data/fetch_chime_frb.py`, `src/scripts/data/fetch_compact_objects.py`, `src/scripts/data/fetch_mcgill_magnetars.py`, `tests/test_c043_compact_objects_catalog_artifact.py`
//!
...
//!   - Where stated: `src/scripts/data/fetch_pdg_particle_data.py`, `tests/test_pdg_coupling_constants.py`, `tests/test_pdg_particle_data.py`
//!
...
//!   - Where stated: `data/csv/c068_zd_interaction_eigen_summary.csv`, `data/csv/reggiani_standard_zero_divisors.csv`, `docs/external_sources/C068_PDG_SPECTRUM_MATCH_SOURCES.md`, `src/scripts/analysis/c068_zd_interaction_spectrum_degeneracy.py`, `tests/test_c068_zd_interaction_spectrum_degeneracy.py`
//!
...
//!   - Where stated: `data/csv/cd_algebraic_experiments_v6.json`, `data/csv/cd_algebraic_experiments_v7_null.json`, `src/scripts/analysis/cd_algebraic_experiments_v6.py`
//!
//! - Hypothesis C-093 (Verified, 2026-01-31): Algebraic Gram matrix Tr(L_i^T L_j) is proportional to identity.
//!   - Where stated: `data/csv/cd_algebraic_experiments_v6.json`, `src/scripts/analysis/cd_algebraic_experiments_v6.py`
//!
...
//!   - Where stated: `data/csv/c097_zd_interaction_graph_summary.csv`, `data/csv/reggiani_standard_zero_divisors.csv`, `src/scripts/analysis/c097_zd_interaction_graph_audit.py`, `tests/test_c097_zd_interaction_graph_audit.py`
//!
...
//!   - Where stated: `data/csv/c129_assoc_norm_dist_by_dim.csv`, `data/csv/c129_assoc_norm_dist_summary.csv`, `data/csv/cd_algebraic_experiments_v13.json`, `docs/external_sources/OPEN_CLAIMS_SOURCES.md`, `src/scripts/analysis/c129_associator_distribution_concentration_audit.py`, `tests/test_c129_associator_distribution_concentration_audit.py`
//!
...
//!   - Where stated: `data/csv/c130_associator_norm_sqrt2_by_dim.csv`, `data/csv/c130_associator_norm_sqrt2_summary.csv`, `data/csv/cd_algebraic_experiments_v14.json`, `docs/external_sources/OPEN_CLAIMS_SOURCES.md`, `src/scripts/analysis/c130_associator_norm_sqrt2_audit.py`, `tests/test_c130_associator_norm_sqrt2_audit.py`
//!
...
//!   - Where stated: `data/csv/c132_commutator_norm_by_dim.csv`, `data/csv/c132_commutator_norm_summary.csv`, `data/csv/cd_algebraic_experiments_v14.json`, `docs/external_sources/OPEN_CLAIMS_SOURCES.md`, `src/scripts/analysis/c132_commutator_norm_convergence_audit.py`, `tests/test_c132_commutator_norm_convergence_audit.py`
//!
...
//!   - Where stated: `docs/convos/CONVOS_CLAIMS_INBOX.md`, `docs/external_sources/C404_HOLOGRAPHIC_MODULAR_LOCALITY_SOURCES.md`, `docs/external_sources/EMERGENCE_LAYERS_SOURCES.md`, `docs/external_sources/EMERGENCE_LAYERS_SUMMARIES.md`, `docs/theory/EMERGENCE_LAYERS_AXIOMS.md`, `src/holography/maxflow.py`, `tests/test_holography_bit_threads.py`
//!
...
//!   - Where stated: `docs/convos/CONVOS_CLAIMS_INBOX.md`, `docs/external_sources/TSCP_METHOD_SOURCES.md`, `docs/preregistered/TSCP_SKY_ALIGNMENT.md`, `reports/tscp_trial_factor_ledger.md`, `src/verification/verify_tscp_prereg_trial_factors.py`, `tests/test_tscp_alignment_offline.py`, `tests/test_tscp_embedding_sweep.py`
//!
...
//!   - Where stated: `data/artifacts/manufacturing/sedenion_spaceplate_bom.csv`, `src/scripts/engineering/generate_digital_matter_bom.py`
//!
...
//!   - Where stated: `data/artifacts/images/genesis_simulation_grand.png`, `src/scripts/simulation/genesis_simulation_v2.py`
//!
...
//!   - Where stated: `data/artifacts/images/holographic_warp_gpu.png`, `src/scripts/engineering/holographic_warp_gate.py`
//!
...
//!   - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/construction/hypercomplex.rs (LEGACY::PATH crates/algebra_core/src/hypercomplex.rs)`
//!
...
//!   - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/construction/hypercomplex.rs (LEGACY::PATH crates/algebra_core/src/hypercomplex.rs)`, `docs/external_sources/OPEN_CLAIMS_SOURCES.md`
//!
...
//!   - Where stated: `data/artifacts/images/kerr_trace_demo.png`, `src/scripts/simulation/integrated_warp_geodesic.py`
//!
...
//!   - Where stated: `data/artifacts/images/kerr_shadow_asymmetry.png`, `src/scripts/simulation/frame_dragging_demo.py`
//!
...
//!   - Where stated: `data/artifacts/images/cosmology_comparison.png`, `src/scripts/analysis/cosmology_comparison.py`
//!
...
//!   - Where stated: `data/artifacts/images/sedenion_slice_3d.png`, `src/scripts/visualization/vis_8d_slice.py`
//!
...
//!   - Where stated: `data/artifacts/images/kerr_trace_demo.png`, `docs/external_sources/OPEN_CLAIMS_SOURCES.md`, `src/scripts/simulation/integrated_warp_geodesic.py`
//!
