...
//!
//! Li, P., Lelli, F., McGaugh, S.S., Schombert, J.M. (2020) ApJS 247 31.
//! Fitting the Radial Acceleration Relation to Individual SDSS Galaxies.
//! Provides per-galaxy NFW fit parameters (r_s, rho_0, chi2) used as priors in E-180, E-182.
//!
