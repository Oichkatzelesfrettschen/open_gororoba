...
//! - `docs/` (repo-authored documentation; ANSI-safe UTF-8)
//! - `docs/convos/` (ANSI-safe UTF-8 extracts derived from `convos/` PDFs)
...
//! - `reports/` (generated human-readable reports; ANSI-safe UTF-8)
...
//!
//! - ANSI-safe UTF-8 gate: `make ansi-check` (repo-authored content; `convos/` exempt)
