...
//! - What would verify/refute it: Verification: Independent replay reproduces the declared population and positive global minimum associator-minus-PVI interval under the sealed procedure.. Revision: A reproducible admission or calculation correction changes the population or endpoint; preserve the original observation and register the corrected bounded successor.; A useful externally validated detector is reproduced by matched generic controls; retain predictive utility while revising any separately proposed algebra-specific explanation.. Abandonment: An independently verified replay on the identical admitted population and sealed algorithm contradicts the reported positive global standalone margin; abandon that numerical claim after resolving implementation provenance.. Inconclusive: A new causal or external interval crosses the declared useful-increment threshold; the extension remains inconclusive and the historical bounded result retains its own evidence.; A decisive input or source identity fails admission; the experiment remains blocked rather than supplying a numerical verdict.
//!
//! ## C-1741
//!
//! - Status: `Verified`
...
//! - Where stated: data/output/audit/staples-calibration-grouped-refits/findings.toml; data/output/audit/staples-calibration-grouped-refits/results/summary.json; data/output/audit/staples-calibration-grouped-refits/completion-audit.json; E-280; E-281
//! - What would verify/refute it: Verification: Independent replay reproduces the declared population and positive global minimum augmented-minus-baseline logistic ROC-AUC interval under the sealed procedure.. Revision: A reproducible admission or calculation correction changes the population or endpoint; preserve the original observation and register the corrected bounded successor.; A useful externally validated detector is reproduced by matched generic controls; retain predictive utility while revising any separately proposed algebra-specific explanation.. Abandonment: An independently verified replay on the identical admitted population and sealed algorithm contradicts the reported positive global logistic increment; abandon that numerical claim after resolving implementation provenance.. Inconclusive: A new causal or external interval crosses the declared useful-increment threshold; the extension remains inconclusive and the historical bounded result retains its own evidence.; A decisive input or source identity fails admission; the experiment remains blocked rather than supplying a numerical verdict.
//!
//! ## C-1742
//!
//! - Status: `Verified`
//! - Last verified: 2026-09-05
//! - Statement: On the retained E-240 subsample (1,733,470 samples, 578,320 positives, 813 THEMIS-A files, seed 42), canonical CD AUC is 0.8274468073. Fifty normalized 2-cocycles yield zero associator terms and AUC 0.5. The 250 basis-alternative 35-line twists yield mean 0.8327338828, central 95 percent interval [0.8280412950, 0.8372935340], maximum 0.8393409816 and 246 draws at or above canonical; canonical lies below that interval. The 250 algebra-isomorphic GL/sign relabelings yield mean 0.8311273052, interval [0.8146826435, 0.8406922873], maximum 0.8424133188 and 217 draws at or above canonical; canonical lies inside that interval. The alternative family has 1080 to 1656 terms; the orbit preserves 1848-term cardinality and 924/924 balance while moving support indices. These families extend the earlier exact-support sign-scramble and random-unital-twist comparisons and refute the registered broader invariant-family criterion; the original E-240 numerical results remain separately retained.
//! - Where stated: data/output/staples_twist_orbit.json; E-279; data/output/audit/staples-orbit-worktree-reconciliation/findings.toml
//! - What would verify/refute it:
//!
//! ## C-1743
//!
//! - Status: `Verified`
//! - Last verified: 2026-09-05
//! - Statement: On the timestamp-causal THEMIS-A crossing-day archive (22,263,526 admitted decisions, 543,911 positives, 813 daily files), training-only preprocessing and ridge-logistic fits on 2007-2012 produce a small positive canonical-associator increment over six matched geometric predictors in held-out 2015 and 2016. Across 2,000 paired whole-daily-file bootstrap draws, the global minimum ROC-AUC increment over calibration widths 64, 256 and 1024 and both final years has approximate 95 percent interval [0.0010149049086891153, 0.0029188809429172872]. The upper endpoint lies below the preregistered investigator-defined 0.005 minimum and rejects the declared useful discrimination increment within the admitted archive. Fourteen to sixteen of nineteen exact-support sign controls equal or exceed canonical point ROC-AUC in every final panel; mechanism-comparison intervals remain unrun. External probe-D inference remains blocked by a backward timestamp independently confirmed in the native source product.
//! - Where stated: data/output/audit/staples-causal-validation/findings.toml; data/output/audit/staples-causal-validation/results/summary.json; data/output/audit/staples-causal-validation/results/bootstrap.json; E-282; E-283
//! - What would verify/refute it: Verification: An independent faithful replay of E-282 reproduces the hash-admitted population, frozen training fits and global-minimum interval with lower endpoint above zero and upper endpoint below 0.005, verifying the two distinct bounded predicates of positive effect and insufficient declared useful increment.; A separately declared, fully admitted external replication applies the frozen THEMIS-A models and reports its own positive-effect and 0.005-threshold intervals; any surviving extension earns a separate scope declaration rather than promoting the completed internal result retroactively.. Revision: An independently resolved admission or numerical correction changes the retained population or interval: preserve C-1743 and the historical parents, record the correction provenance, and register only the narrower successor supported by the corrected experiment.; Adequately precise canonical-minus-control comparisons reproduce the predictive signal with exact-support generic cubic controls: retain the supported detector observation while revising any separately proposed algebra-specific explanation. The observed point ranks alone do not establish that uncertainty-adjusted conclusion.; A faithful corrected replay produces an interval that touches or crosses 0.005: revise the below-threshold classification to inconclusive for the corrected evidence instead of selecting a favorable final width or secondary metric.. Abandonment: After resolving implementation and input provenance, a faithful replay or sufficiently precise replication yields a global-minimum interval wholly at or below zero: abandon the positive-increment assertion for that tested scope while preserving the original reported observation.; After resolving implementation and input provenance, a faithful corrected replay yields a lower endpoint strictly above 0.005: abandon the below-threshold assertion for the corrected scope because the declared useful increment survives its preregistered criterion.; A sufficiently precise admitted interval has upper endpoint strictly below 0.005: reject the proposed useful discrimination increment for that scope, even when its lower endpoint exceeds zero. E-282 supplies this completed rejection; operational cost-benefit remains a separate unmeasured predicate.. Inconclusive: An interval contains zero, or dependence and support uncertainty prevents a sufficiently precise positive-effect decision: the positive-effect extension remains inconclusive rather than becoming an absence-of-effect claim.; An interval touches or crosses 0.005, or the declared file/class/precision requirements fail: the proposed useful increment remains inconclusive.; Canonical-minus-control uncertainty intervals remain unrun or insufficiently precise: algebra-specific superiority remains inconclusive despite fourteen to sixteen controls equaling or exceeding canonical point ROC-AUC in every final panel.; External retrieval, identity or chronological admission remains unresolved: E-283 remains blocked with zero numerical inference. Provider-corrected source bytes require preserved provenance and a separately declared intake; sorting, deduplicating or omitting the failed date cannot manufacture campaign completion.
