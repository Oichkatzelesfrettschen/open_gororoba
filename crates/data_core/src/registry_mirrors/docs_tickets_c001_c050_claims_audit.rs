...
//! - `data/papers/corpus/arxiv_1502.05293_chanyal_2015_octonionic_gravi_electromagnetism_dark_matter.pdf`
//! - `data/papers/corpus/scirp_2014_mironov_sedeonic_equations_gravitoelectromagnetism.pdf`
//! - `data/papers/intake/traces/chanyal_2014_academia_requires_login.txt`
