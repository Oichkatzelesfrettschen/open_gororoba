...
//!   - Where stated: `crates/spectral_core/src/neg_dim.rs`, `data/csv/neg_dim_free_eta_comparison_results.csv`, `data/csv/neg_dim_model_comparison_results.csv`, `docs/NAVIGATOR.md`, `docs/NEGATIVE_DIMENSION_DARK_ENERGY_MODEL.md`, `docs/NEG_DIM_MULTIPROBE_EXPERIMENT.md`, `docs/PHYSICAL_INTERPRETATION.md`, `docs/external_sources/ADDITIONAL_COSMOLOGICAL_DATASETS.md`, `docs/external_sources/COSMOLOGY_MULTIPROBE_SOURCES.md`, `docs/external_sources/HZ_DATASETS_SOURCES.md`, `docs/external_sources/NEGATIVE_DIMENSION_SOURCES.md`, `docs/preregistered/NEG_DIM_FREE_ETA_AMENDMENT.md`, `docs/preregistered/NEG_DIM_MODEL_COMPARISON.md`, `src/scripts/analysis/neg_dim_free_eta_comparison.py`, `src/scripts/analysis/neg_dim_model_comparison.py`, `src/scripts/data/fix_bao_observables.py`, `tests/test_neg_dim_dark_energy.py`, `tests/test_neg_dim_free_eta_comparison.py`, `tests/test_neg_dim_multidata.py`
//!
...
//!   - Where stated: `data/papers/corpus/arxiv_gr-qc0407051_domagala_lewandowski_2004_bh_entropy_quantum_geometry.pdf`, `data/papers/corpus/arxiv_gr-qc0407052_meissner_2004_bh_entropy_lqg.pdf`, `data/papers/corpus/arxiv_hep-th0504052_nojiri_odintsov_sasaki_2005_gauss_bonnet_dark_energy.pdf`, `docs/C037_NUMERICAL_COINCIDENCE_AUDIT.md`, `docs/EXCEPTIONAL_COSMOLOGY.md`, `docs/convos/pdf_extract_2b693d92f57d_exceptional_cosmological_framework_synthesis.md`, `docs/external_sources/EXCEPTIONAL_COSMOLOGY_SOURCES.md`
//!
...
//!   - Where stated: `data/papers/corpus/arxiv_gr-qc0306060_larranaga_2003_introduction_to_bosonic_string_theory.pdf`, `docs/C041_F4_STRING_DIMENSION_COINCIDENCE_AUDIT.md`, `docs/EXCEPTIONAL_COSMOLOGY.md`, `docs/convos/pdf_extract_2b693d92f57d_exceptional_cosmological_framework_synthesis.md`, `docs/external_sources/EXCEPTIONAL_COSMOLOGY_SOURCES.md`
//!
...
//!   - Where stated: `data/external/bao/`, `src/scripts/data/fetch_desi_dr1_bao.py`, `tests/test_desi_dr1_bao.py`
//!
...
//!   - Where stated: `data/csv/nanograv_15yr_free_spectrum.csv`, `src/scripts/data/fetch_nanograv_15yr.py`, `tests/test_nanograv_15yr.py`
//!
...
//!   - Where stated: `data/papers/corpus/arxiv_2601.23279v1_ahmadiniaz_2026_photon_graviton_mixing.pdf`, `docs/BIBLIOGRAPHY.md`
//!
...
//!   - Where stated: `data/papers/corpus/arxiv_2601.23137v1_son_chekhova_2026_sfwm_thin_layer.pdf`, `docs/BIBLIOGRAPHY.md`
//!
...
//!   - Where stated: `crates/gororoba_cli_physics/src/bin/dm_ultrametric.rs`, `crates/stats_core/src/ultrametric/local.rs`, `data/csv/c071b_dm_comoving_ultrametric.csv`
//!
...
//!   - Where stated: `crates/gororoba_cli_data/src/bin/baire_compact.rs`, `crates/stats_core/src/ultrametric/baire.rs`, `data/csv/c071c_baire_compact_ultrametric.csv`
//!
...
//!   - Where stated: `crates/gororoba_cli_data/src/bin/multi_dataset_ultrametric.rs`, `data/csv/c071g_multi_dataset_ultrametric.csv`, `docs/INSIGHTS.md`
//!
