...
//!
//! **Source:** data/papers/corpus/de_marrais_2004_wolfram_science_slides.pdf
//!
//!
//!
//! ## Full Transcript
...
//! strategy: after many years' imbalance, William Rowan Hamilton was able to generalize
...
//! tic: for, generally speaking, a<U+00B7>(b<U+00B7>c) and (a<U+00B7>b)<U+00B7>c may well have opposite signs! (Hence,
...
//! pairing "emanates" the third: e.g., ( SA , oA ) <U+00B7> ( SB , oB ) = + ( SC , oC ) - ( SC , oC ) = 0) and
...
//! By cycling according to the same logic, (3 xor 1 = 11 xor 9 = 2) <U+2192> (2, 9, 11), and (1 xor 2
//! = 9 xor 10 = 3) <U+2192> (3, 10, 9). By proceeding similarly with (1, 4, 5), rows 1 of the 2nd
...
//! density of ZD's <U+2192> 0 as N <U+2192> <U+221E>? Would that imply (and quite counterintuitively) that
...
//! (shorthanded "ZM#" in the table). Note that vertex locations are rotated ( <U+00AE> ) in 4 of the
...
//! "stereo Fano" manner of showing Pl<U+00E9>iade symmetries. In the little table at the top of the
...
//! copy of PSL(2,7) can uniquely serve to integrate all a Pl<U+00E9>iade's Box-Kites (with its "sha-
