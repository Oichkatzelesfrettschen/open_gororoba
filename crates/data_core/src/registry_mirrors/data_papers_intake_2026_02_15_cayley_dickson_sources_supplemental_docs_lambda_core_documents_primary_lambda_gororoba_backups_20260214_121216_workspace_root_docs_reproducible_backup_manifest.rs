...
//! - Root module document snapshots (`research`, `experiments`, `learner`).
//! - Workspace-level document snapshot under `workspace_root/` (root markdown + `docs/`, `scripts/`, `src/`, `logs/` document classes).
