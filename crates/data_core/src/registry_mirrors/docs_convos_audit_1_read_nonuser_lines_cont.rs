...
//! >   - keep all repo-authored annotations ANSI-safe UTF-8 (avoid embedded control escapes and unstable Unicode math in titles/labels),
...
//! >   - keep annotations ANSI-safe UTF-8 and save artifacts deterministically.
//! - Source needs (first-party):
...
//! >   - keep all repo-authored annotations ANSI-safe UTF-8 and save artifacts deterministically.
//! - Source needs (first-party):
...
//! >   - keep repo-authored text ANSI-safe UTF-8 and remove any embedded control escapes or unstable Unicode minus signs from titles/labels,
