...
//! | C-053 | materials | Verified (toy mapping; di... | 2026-03-11 | Toy mapping: Pathion (32D) tensor diagonal -> dielectric stack (TMM retrieval). | crates/materials_core/src/pathion_toy_mapping.rs, crates/gororoba_cli_physic... | The Rust-native toy mapping makes the diagonal-only degeneracy explicit: ever... |
