...
//! - Where stated: `crates/algebra_analysis/src/boxkites.rs`, `docs/SEDENION_ATLAS.md`, `docs/external_sources/DE_MARRAIS_SOURCES.md`, `tests/test_de_marrais_boxkites.py`
//!
...
//! - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/lie/group_theory.rs (LEGACY::PATH crates/algebra_core/src/group_theory.rs)`, `crates/algebra_analysis/src/boxkites.rs`, `docs/SEDENION_ATLAS.md`, `docs/external_sources/PSL_2_7_SOURCES.md`, `tests/test_boxkite_symmetry_action.py`, `tests/test_psl_2_7_action.py`
//!
...
//! - Where stated: `data/papers/corpus/reggiani_2024_2411.18881.pdf`, `docs/SEDENION_ATLAS.md`, `docs/external_sources/REGGIANI_MANIFOLD_CLAIMS.md`, `docs/theory/REGGIANI_GEOMETRIC_VALIDATION.md`
//!
...
//! - Where stated: `data/csv/gravastar_eos_pressure_gradient_sweep.csv`, `data/csv/gravastar_nonassociative_obstruction.csv`, `data/csv/gravastar_thin_shell_matching.csv`, `data/csv/gravastar_thin_shell_stability.csv`, `docs/NAVIGATOR.md`, `docs/NEGATIVE_DIMENSION_CLARIFICATIONS.md`, `docs/SEDENION_GRAVASTAR_EQUIVALENCE.md`, `docs/external_sources/GRAVASTAR_SOURCES.md`, `docs/theory/GRAVASTAR_CD_IMPOSSIBILITY_ANALYSIS.md`, `src/scripts/analysis/gravastar_eos_sweep.py`, `src/scripts/analysis/gravastar_nonassociative_obstruction.py`, `src/scripts/analysis/gravastar_thin_shell.py`, `src/scripts/analysis/gravastar_thin_shell_stability.py`, `tests/test_gravastar_nonassociative_obstruction.py`, `tests/test_gravastar_thin_shell.py`, `tests/test_gravastar_thin_shell_stability.py`, `tests/test_tov_gravastar_core.py`, `tests/test_tov_gravastar_sweep.py`
//!
...
//! - Where stated: `crates/algebra_analysis/src/boxkites.rs`, `docs/DE_MARRAIS_REPLICATION.md`
//!
...
//! - Where stated: `crates/algebra_analysis/src/reggiani.rs`, `docs/REGGIANI_REPLICATION.md`
//!
...
//! - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/physics/m3.rs (LEGACY::PATH crates/algebra_core/src/m3.rs)`, `docs/CONVOS_CONCEPTS_STATUS_INDEX.md`
//!
...
//! - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/construction/wheels.rs (LEGACY::PATH crates/algebra_core/src/wheels.rs)`, `data/csv/cd_wheel_roundtrip_results.csv`, `docs/external_sources/WHEELS_CAYLEY_DICKSON_SOURCES.md`, `docs/theory/WHEELS_CD_STRUCTURAL_ANALYSIS.md`, `src/scripts/analysis/cd_wheel_roundtrip_test.py`
//!
...
//! - Where stated: `crates/algebra_analysis/src/grassmannian.rs`, `data/csv/cd_fiber_holonomy_comparison.csv`, `data/csv/cd_holonomy_basis_triples.csv`, `docs/theory/unified_tensor_wheel_cd_framework.md`, `src/scripts/analysis/cd_fiber_holonomy_analysis.py`, `tests/test_cd_holonomy.py`
//!
...
//! - Where stated: `docs/SEDENION_FIELD_THEORY.md`, `docs/convos/pdf_extract_3f6ee1e837d1_sedenion_valued_field_theories_action_principles_and_challenges.md`
//!
...
//! - Where stated: `data/csv/c030_sedenion_lagrangian_bypass_checks.csv`, `docs/C030_SEDENION_LAGRANGIAN_BYPASS.md`, `docs/SEDENION_FIELD_THEORY.md`, `docs/convos/pdf_extract_3f6ee1e837d1_sedenion_valued_field_theories_action_principles_and_challenges.md`, `docs/external_sources/C030_SEDENION_LAGRANGIAN_SOURCES.md`, `src/scripts/analysis/c030_sedenion_lagrangian_bypass_checks.py`, `tests/test_c030_sedenion_lagrangian_bypass_checks.py`
//!
...
//! - Where stated: `data/csv/c032_tang_2025_associator_basis_triples.csv`, `data/csv/c032_tang_2025_associator_subalgebra_summary.csv`, `data/csv/c032_tang_2025_table2_lepton_masses.csv`, `docs/BIBLIOGRAPHY.md`, `docs/SEDENION_FIELD_THEORY.md`, `docs/convos/pdf_extract_3f6ee1e837d1_sedenion_valued_field_theories_action_principles_and_challenges.md`, `docs/external_sources/C032_TANG_2025_SEDENIONIC_QED_SOURCES.md`, `src/scripts/analysis/c032_tang_2025_min_reproduction.py`, `tests/test_c032_tang_2025_min_reproduction.py`
//!
...
//! - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/lie/group_theory.rs (LEGACY::PATH crates/algebra_core/src/group_theory.rs)`, `data/csv/c033_su5_generator_summary.csv`, `data/papers/corpus/arxiv_2308.14768_tang_tang_2023_sedenion_su5_generations.pdf`, `data/papers/corpus/arxiv_2308.14768_tang_tang_2023_sedenion_su5_generations.txt`, `docs/BIBLIOGRAPHY.md`, `docs/C033_SU5_MAPPING_CLOSURE.md`, `docs/SEDENION_FIELD_THEORY.md`, `docs/convos/pdf_extract_3f6ee1e837d1_sedenion_valued_field_theories_action_principles_and_challenges.md`, `docs/external_sources/SEDENION_FIELD_THEORY_SOURCES.md`, `src/scripts/analysis/c033_su5_generator_summary.py`, `tests/test_su5_generators.py`
//!
...
//! - Where stated: `data/csv/c034_sedenion_doubling_identity_check.csv`, `data/papers/intake/traces/chanyal_2014_springer_abstract.txt`, `docs/BIBLIOGRAPHY.md`, `docs/C034_CHANYAL_2014_REPRODUCTION.md`, `docs/SEDENION_FIELD_THEORY.md`, `docs/convos/pdf_extract_3f6ee1e837d1_sedenion_valued_field_theories_action_principles_and_challenges.md`, `docs/external_sources/C034_CHANYAL_2014_GRAVI_ELECTROMAGNETISM_SOURCES.md`, `src/scripts/analysis/c034_chanyal_2014_structural_reproduction.py`, `tests/test_c034_sedenion_doubling_identity.py`
//!
...
//! - Where stated: `CURRENT::PATH crates/gororoba_algebra/src/construction/wheels.rs (LEGACY::PATH crates/algebra_core/src/wheels.rs)`
//!
...
//! - Where stated: `data/csv/cd_algebraic_experiments_v3.json`, `src/scripts/analysis/cd_algebraic_experiments_v3.py`
//!
...
//! - Where stated: `data/csv/c099_nondiag_zd_geometry_summary.csv`, `data/csv/cd_algebraic_experiments_v8.json`, `src/scripts/analysis/c099_nondiag_zd_geometry_audit.py`, `tests/test_c099_nondiag_zd_geometry_audit.py`
//!
...
//! - Where stated: `crates/algebra_analysis/src/boxkites.rs`, `docs/INSIGHTS.md`
//!
