...
//! | 2 | `field_name` | `TEXT` | `true` | `` | `0` | `0` |
//! | 3 | `prev_value_sha256` | `TEXT` | `false` | `` | `0` | `0` |
//! | 4 | `new_value_sha256` | `TEXT` | `true` | `` | `0` | `0` |
//! | 5 | `actor` | `TEXT` | `true` | `` | `0` | `0` |
//! | 6 | `reason` | `TEXT` | `false` | `` | `0` | `0` |
//! | 7 | `ts_utc` | `TEXT` | `true` | `strftime('%Y-%m-%dT%H:%M:%fZ', 'now')` | `0` | `0` |
//! | 8 | `operation` | `TEXT` | `true` | `` | `0` | `0` |
//! | 9 | `application_id` | `INTEGER` | `false` | `` | `0` | `0` |
//!
//! Foreign keys:
//!
//! | id | seq | table | from | to | on update | on delete | match |
...
//! | seq | name | unique | origin | partial | columns |
//! | --- | --- | --- | --- | --- | --- |
//! | 0 | `experiment_revisions_by_actor` | `false` | `c` | `false` | `actor, ts_utc, <expr>` |
//! | 1 | `experiment_revisions_by_experiment` | `false` | `c` | `false` | `experiment_id, ts_utc, <expr>` |
//!
...
//! | seq | name | unique | origin | partial | columns |
//! | --- | --- | --- | --- | --- | --- |
//! | 0 | `insight_revisions_by_actor` | `false` | `c` | `false` | `actor, ts_utc, <expr>` |
//! | 1 | `insight_revisions_by_insight` | `false` | `c` | `false` | `insight_id, ts_utc, <expr>` |
//!
//! ## `insights` (table)
//!
//! - Strict: `false`
