...
//!
//! - Bonferroni/Sidak background: `data/papers/corpus/abdi_2007_bonferroni_sidak_corrections.pdf`
//! - Holm procedure: `data/papers/corpus/holm_1979_sequentially_rejective_multiple_test_procedure.pdf`
//!
//! ## Notes
//!
