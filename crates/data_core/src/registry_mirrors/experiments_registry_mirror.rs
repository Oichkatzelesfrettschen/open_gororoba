...
//!
//! Method:
//! Hold five numerator increments over six samples fixed. Compare daily-file RMS, one pooled training-file RMS, and 256-increment RMS from preceding input-row order; equal timestamps preclude strict temporal precedence. Refit baseline and augmented logistic models under five file-grouped five-fold splits. The protocol retains label time k+4 and feature availability k+5.
//!
//! Run command:
//! ```bash
