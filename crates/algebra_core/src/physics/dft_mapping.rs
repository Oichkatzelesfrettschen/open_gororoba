...
pub fn map_basis_to_sector(i: usize) -> DftForceSector {
    if i == 0 { return DftForceSector::Gravity; }
    if i < 2 { return DftForceSector::TemporalFlux; }
    if i < 4 { return DftForceSector::Spacetime; }
    if i < 8 { return DftForceSector::Magnetism; }
    if i < 16 { return DftForceSector::Electricity; }
    if i < 32 { return DftForceSector::WeakNuclear; }
    if i < 64 { return DftForceSector::StrongNuclear; }
