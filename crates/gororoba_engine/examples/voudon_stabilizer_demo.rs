...
fn main() -> anyhow::Result<()> {
    ...
    println!("Searching for up to {} stable Voudon cycles in 256D manifold...", max_triples);
    let stable_cycles = VoudonStabilizerGpu::find_stable_cycles(max_triples)
    ...
    let ny = 64;
    let nz = 64;
    println!("\nInitializing CUDA LBM solver for stability analysis ({}x{}x{})...", nx, ny, nz);
    ...
    let tau_base = 0.6;
    println!("Applying topological stabilization (alpha = {})...", alpha_stable);
