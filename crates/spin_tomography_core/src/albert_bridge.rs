...
pub fn embed_to_albert(_state: &TwoQubitState, a: &Vector3<f64>, b: &Vector3<f64>, t: &Matrix3<f64>) -> AlbertElement {
...
pub fn albert_delta_sq(state: &TwoQubitState, a: &Vector3<f64>, b: &Vector3<f64>, t: &Matrix3<f64>) -> f64 {
