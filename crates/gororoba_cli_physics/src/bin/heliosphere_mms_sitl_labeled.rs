...
struct Cli {
    ...
    /// local-|B|-normalized Takens embedding.  Prevents near-zero mean |B|
    /// at magnetic null points from amplifying instrument noise into spurious
    /// associator spikes.  MMS FGM published noise floor: ~0.1 nT.
