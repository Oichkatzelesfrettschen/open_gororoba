...
#[derive(Parser, Debug)]
#[command(author, version, about = "Cosmological Expansion Sweep CLI integrating Lambda_sed")]
struct Args {
...
fn main() -> Result<()> {
    let args = Args::parse();
    println!("Starting Cosmology Lambda Sweep with F_vac = {}", args.imbalance_attractor);
