...
use data_core::{
    ...
    catalogs::{
        ...
        psp_fields_fetch::parse_psp_fields_file,
        psp_spc_fetch::parse_psp_spc_l3i_file,
        psp_spi_fetch::parse_psp_spi_mom_file,
        psp_sqtn_fetch::parse_psp_sqtn_file,
        soho_celias::{
        ...
        solar_orbiter_rpw_fetch::parse_solar_orbiter_rpw_file,
        solar_orbiter_rpw_density::parse_solar_orbiter_rpw_density_file,
        solar_orbiter_rpw_hfr_fetch::parse_solar_orbiter_rpw_hfr_file,
        solar_orbiter_rpw_tnr_fetch::parse_solar_orbiter_rpw_tnr_file,
