...
pub fn get_contracts() -> HashMap<Stage, StageContract> {
    ...
    c.insert(Stage::TopicInit, StageContract {
    ...
    c.insert(Stage::ProblemDecompose, StageContract {
    ...
    c.insert(Stage::SearchStrategy, StageContract {
        stage: Stage::SearchStrategy,
        input_files: vec!["problem_tree.md".into()],
        output_files: vec!["search_plan.yaml".into(), "sources.json".into(), "queries.json".into()],
        dod: ">=2 search strategies defined with verified data sources".into(),
        error_code: "E03_STRATEGY_BAD".into(),
        max_retries: 1,
    });

    c.insert(Stage::LiteratureCollect, StageContract {
    ...
    c.insert(Stage::LiteratureScreen, StageContract {
    ...
    c.insert(Stage::KnowledgeExtract, StageContract {
    ...
    c.insert(Stage::Synthesis, StageContract {
    ...
    c.insert(Stage::HypothesisGen, StageContract {
