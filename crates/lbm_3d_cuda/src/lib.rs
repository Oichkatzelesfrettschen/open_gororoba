...
//!
//! - Module ID: `REQ-LBM-CUDA`
//! - Module name: `lbm_3d_cuda`
//! - Status: `active`
//! - Install targets:
...
// Re-export the dark halo solver at the crate root so existing
// `lbm_3d_cuda::DarkHaloCudaSolver` call sites keep working after the split.
pub use dark_halo::{CudaDarkHaloResult, DarkHaloCudaSolver};
