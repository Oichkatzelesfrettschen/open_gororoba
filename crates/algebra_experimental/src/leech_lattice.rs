//! Leech lattice (Lambda_24) implementation.
//!
//! The Leech lattice is the unique even unimodular lattice in 24 dimensions
//! with no vectors of norm 2. Properties:
//! - Minimum norm: 4 (kissing number 196560)
//! - Covering radius: sqrt(2)
//! - Deep holes: 23 types (corresponding to the 23 other Niemeier lattices)
//!
//! This module provides:
//! - Generator matrix via Construction A from the extended Golay code
//! - Babai nearest-plane CVP (approximate closest vector problem)
//! - Hole classification (lattice point / shallow hole / deep hole)
//!
//! # References
