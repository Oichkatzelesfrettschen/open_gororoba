...
//!
//! Usage:
//!   cargo run --bin warp --release --features gpu -- gpu-experiment --experiment A
//!   cargo run --bin warp --release --features gpu -- gpu-experiment --experiment B
//!   cargo run --bin warp --release --features gpu -- gpu-experiment --experiment C
