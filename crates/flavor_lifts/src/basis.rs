...
use cd_kernel::cayley_dickson::{SignTable, cd_multiply, cd_associator_norm};
...
pub fn extract_vk_basis(dim: usize, max_rank: usize) -> (DMatrix<f64>, Vec<f64>, Vec<(usize, usize)>) {
