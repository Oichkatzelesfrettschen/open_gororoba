...
// tracking, and the SpringConstantResult diagnostic record all live in
// the `validity` submodule (Emig et al. PRL 96, 220401).
pub mod validity;
pub use validity::{
    CasimirError, PfaValidityInfo, SPRING_CONSTANT_ERROR_FACTOR, SpringConstantResult,
    casimir_force_guarded, casimir_force_with_validity, casimir_spring_constant_guarded,
    check_pfa_validity, spring_constant_strict, spring_constant_with_diagnostics,
