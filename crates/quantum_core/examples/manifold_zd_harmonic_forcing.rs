...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    writeln!(file, "radius_x,v_nfw,v_zd_sedenion,v_zd_pathion,v_total_16d,v_total_32d")?;
    ...
    println!("✅ ZD Harmonic Forcing Profiles generated at {}", out_path.display());
    println!("   - 16D Forcing utilizes the 7-mode Box-Kite spectrum (FBF = 1/2).");
    println!("   - 32D Forcing utilizes the 15-mode PG(3,2) spectrum with the (FBF = 4/7) Pathion Anomaly amplification.");
