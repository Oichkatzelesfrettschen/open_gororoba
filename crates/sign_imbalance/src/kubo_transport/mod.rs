...
//! replacing the ad hoc imbalance)` coupling.
//!
...
/// `alpha`: imbalance parameter J2/J1.
...
/// Imbalance parameter for a Heisenberg model on a graph.
///
...
pub fn graph_imbalance_index(model: &HeisenbergModel) -> f64 {
    let n = model.n_sites;
