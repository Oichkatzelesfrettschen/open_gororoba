...
// D3Q19 MRT collision operators (d'Humieres 2002) live in the `mrt`
...
pub(crate) type Result<T> = std::result::Result<T, LbmError>;

// BGK collision operator (sum_19 helper, CollisionMode selector,
// BgkCollision struct + impl) lives in the `bgk` submodule. Re-exports
// preserve the public API at lbm_3d::solver::{CollisionMode, BgkCollision}.
mod bgk;
pub use bgk::{BgkCollision, CollisionMode};

// AoSoA layout helpers (AOSOA_CHUNK constant, aosoa_idx, aosoa_pad
