...
mod tests {
    ...
    fn test_composition_morphism() {
        assert!(CompositionAlgebraCategory::is_valid_morphism(DivisionAlgebra::R, DivisionAlgebra::C));
        assert!(!CompositionAlgebraCategory::is_valid_morphism(DivisionAlgebra::O, DivisionAlgebra::H));
    }
