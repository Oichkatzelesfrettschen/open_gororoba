...
fn all_providers() -> Vec<Box<dyn DatasetProvider>> {
    ...
    vec![
        ...
        Box::new(sdss_fetch::SdssQsoProvider),
        Box::new(desi_bao_fetch::DesiBaoProvider),
        Box::new(nanograv_fetch::NanoGrav15yrProvider),
        Box::new(nanograv_fetch::NanoGrav15yrTimingProvider),
        Box::new(planck_fetch::PlanckChainsProvider),
        Box::new(planck_fetch::Wmap9ChainsProvider),
        Box::new(planck_fetch::PlanckSummaryProvider),
        Box::new(fermi_gbm_fetch::FermiGbmProvider),
        Box::new(gaia_fetch::GaiaDr3Provider),
        Box::new(hipparcos::HipparcosProvider),
        Box::new(mcgill::McgillProvider),
        // EHT VLBI (6 targets)
        Box::new(eht_fetch::EhtM87_2017Provider),
        Box::new(eht_fetch::EhtM87Provider),
        Box::new(eht_fetch::EhtSgrAProvider),
        Box::new(eht_fetch::Eht3c279Provider),
        Box::new(eht_fetch::EhtCenAProvider),
        Box::new(eht_fetch::EhtM87LegacyProvider),
        // Solar / TSI
        ...
        // Wow! Signal
        Box::new(wow_fetch::WowPrintoutProvider),
        Box::new(wow_fetch::Bl6equj5ManifestProvider),
        // Heavy-ion R_AA (HEPData)
        Box::new(hic_raa_fetch::HicRaaProvider),
    ]
}
