...
#[derive(Parser, Debug)]
#[command(
    name = "nanograv-propagation-audit",
    about = "Per-pulsar propagation diagnostics and first-pass Hellings-Downs pair audit over the NANOGrav 15-year timing release"
)]
struct Args {
    #[arg(
        long,
