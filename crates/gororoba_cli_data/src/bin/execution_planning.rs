...
fn render_roadmap(meta: &Table, rows: &[PlanningRow]) -> Result<String> {
    ...
    let mut lines = vec![
        "# Operational roadmap registry (TOML-first, schema-hardened).".to_string(),
        "# Generated by src/scripts/analysis/build_wave5_batch4_registries.py.".to_string(),
        String::new(),
        "[roadmap]".to_string(),
        format!(
...
fn render_todo(rows: &[PlanningRow]) -> Result<String> {
    let mut lines = vec![
        "# To-Do Registry (TOML-first, schema-hardened).".to_string(),
        "# Generated by src/scripts/analysis/build_wave5_batch4_registries.py.".to_string(),
        String::new(),
        "[todo]".to_string(),
        "updated = \"2026-02-10\"".to_string(),
...
fn render_next_actions(rows: &[PlanningRow]) -> Result<String> {
    let mut lines = vec![
        "# Next Actions Registry (TOML-first, schema-hardened).".to_string(),
        "# Generated by src/scripts/analysis/build_wave5_batch4_registries.py.".to_string(),
        String::new(),
        "[meta]".to_string(),
        "updated = \"2026-02-10\"".to_string(),
...
fn render_requirements(
    ...
    let mut lines = vec![
        "# Requirements registry (TOML-first, schema-hardened).".to_string(),
        "# Generated by src/scripts/analysis/build_wave5_batch4_registries.py.".to_string(),
        String::new(),
