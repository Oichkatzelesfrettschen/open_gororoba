    ...
    for z in 0..n {
        for y in 0..n {
            for x in 0..n {
                ...
                let dx = x as f32 - center; let dy = y as f32 - center; let dz = z as f32 - center;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for frame in 0..600 {
        ...
        if frame % 50 == 0 { println!("  Fidelity Progress: {}/600", frame); }
    }

    println!("Finalizing Video...");
    let _ = std::process::Command::new("ffmpeg")
        .args(["-y", "-framerate", "30", "-i", "data/artifacts/c756_frames/frame_%04d.png", "-c:v", "libx264", "-pix_fmt", "yuv420p", "-crf", "15", "data/artifacts/c756_production.mp4"])
        .output();
