...
// CLI Args + AppState + ~20 request/response DTOs + UI asset
// constants + endpoint timeout/version constants live in the
// `types` submodule. #[path] indirection because this binary has
// an explicit Cargo.toml path.
#[path = "gororoba_studio/types.rs"]
mod types;
use types::*;
