...
- Some scientific wheels may not exist for very new Python versions; if installs
  fail, use a container or a Python 3.11/3.12 environment for this module.

## Data governance and provenance

Analysis outputs are treated as reproducible build artifacts and must pass
Rust-native governance checks:
