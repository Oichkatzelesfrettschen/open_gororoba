...
- Hypothesis C-025 (**Refuted** (Phase 5), 2026-01-31): GWTC-3 black hole sky positions cluster around projected sedenion zero-divisor coordinates (CMB-aligned box-kite projection).
  - Where stated: `docs/stellar_cartography/theory/HYPOTHESIS_DEF.md`, `src/gemini_physics/stellar_cartography/algebra_bridge.py`, `src/gemini_physics/stellar_cartography/simulation.py`, `docs/preregistered/TSCP_SKY_ALIGNMENT.md`, `tests/test_tscp_alignment_offline.py`, `docs/external_sources/TSCP_SKY_ALIGNMENT_SOURCES.md`
