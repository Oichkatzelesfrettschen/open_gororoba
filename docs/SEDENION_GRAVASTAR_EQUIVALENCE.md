...
In the gravastar model, the core satisfies P = −ρ (dark energy equation of state) and the shell is a thin layer of stiff matter. The anti-diffusion character of the core — negative pressure gradient pushing outward — is the defining feature.
...
- The negative dimension model D_eff = −1.5 was refuted by cosmological data (it gives incorrect w₀, n_s, H₀ values).
