...
%% Supporting experiments: E-237..E-241  |  Claims: C-1629..C-1634
...
\midrule
MC1 & Major & Added tau sweep ablation & E-240, \S3, Fig.~1, Table~1 \\
MC2 & Major & Added Alfvenic control + micro-switchback & E-239, E-241, \S4--5, Fig.~2--4, Table~2--3 \\
MC3 & Major & Gap detection, spin tone note, $\varepsilon$ documentation & E-237 binary update, \S2 \\
...
We have added a full tau sensitivity sweep (new Section~3, Experiment~E-240)
...
\texttt{heliosphere-takens-tau-sweep} binary (E-240); output at\\
...
\begin{authorresponse}
This comment is addressed by two new experiments (E-239 and E-241).

\textbf{Alfvenic control (E-239, new Section~4).}
...
\textbf{Micro-switchback correlation (E-241, new Section~5).}
...
\texttt{heliosphere-psp-alfven-control} (E-239),
\texttt{heliosphere-psp-switchback-correlation} (E-241);
...
\begin{enumerate}
  ...
  \item \textbf{New Section~4} (\S4): Alfvenic Control Analysis -- PSP E3
...
additions.  In particular, Experiments~E-241 directly addresses the core
concern of MC2 with a falsifiable quantitative result ($1.72\times$
enrichment, $32.5\%$ rotation-free), and Experiment~E-240 establishes
