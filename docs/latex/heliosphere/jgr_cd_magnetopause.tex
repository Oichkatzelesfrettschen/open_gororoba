...
FGM \citep{auster2008} minutes), containing 224 labeled crossing events.  A detection within
...
1-minute interval from Parker Solar Probe \citep{fox2016} Encounter 3
...
THEMIS FGM data were obtained from the HAPI server \citep{bonnell2019}
