%% Figure: PSP E3 Alfvenic control -- CD vs gradient fire rates by window class
%% Data source: data/output/heliosphere/ablations/psp_alfven_control.json
%% Experiment: E-239  |  Claim: C-1631/C-1632
%%
...
%%
%% PSP Encounter 3: 2020-01-20 to 2020-02-10  (31673 minutes)
...
\begin{axis}[
    ...
    title={PSP E3 fire rates by window class (2020-01-20 -- 2020-02-10)},
]
