...
- **Refuted strong claims:** w_0 = -5/6 (C-038), n_s from D_eff (C-040), F4 -> string D=26 (C-041), \gamma ~ \epsilon (C-037), triality clustering (C-036)
- **Verified exact identities:** F4 Casimir \epsilon = 1/4 (C-035)
