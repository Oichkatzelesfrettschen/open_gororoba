...
| Chapter VII | `proofs/theories/Brown1972ChapterVII.v` plus `ZD_Criterion.v`, `C1538_MorZDSymmetry.v`, `BrownAssessorEquivalence.v`, `SStructuralGaps.v`, Rust support | Brown-facing wrapper surface now landed for 7.3, 7.15, the box-kite partition summary, and the Brown/de Marrais bridge summary, with a fused zero-divisor witness wrapper for 7.3, a basis-decomposed fused proof of the Moreno-Froloff 7.3 witness, fused support lemmas for the Brown 7.15 fundamental criterion now mined in `ZD_Criterion.v`, a structural Brown 7.16 landing that packages the fused 7.15 witness with the finite box-kite/signature summary, a direct fused Brown 7.16(ii) antiassociator witness for the fundamental 7.15 quadruple, and an abstract Brown-proof-shape `7.15 -> 7.14 -> 7.17` bridge now exposed in `SStructuralGaps.v` and used to land Brown Lemma 7.17 in `Brown1972ChapterVII.v`; the same fused criterion support is now imported directly by the Moreno/de Marrais companion theorem files `C1538_MorZDSymmetry.v`, `BrownAssessorEquivalence.v`, and `DeMarraisAssessors.v`, while the broader Brown-numbered zero-divisor lane is still not chapter-complete |
