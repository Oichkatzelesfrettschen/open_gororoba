...
| ------- | --------------------------------- | ---- | --------- | --------------------------- |
| R16     | 2 (Bx, By)                        | 8    | 16        | Drops Bz and                |
| R32     | 4 (Bx, By, Bz,                    | B    | -mean)    | 8                           |
...
_Rationale:_ The CD associator captures nonlinear cross-lag interactions
...
_Rationale:_ If true, the specific CD coefficient structure contributes
...
_Rationale:_ The 8-min window captures the median crossing timescale.
Shorter windows miss multi-minute transitions.

**P4:** CD R16 (2 channels) F1 will be LOWER than CD R32 (4 channels).
_Rationale:_ Bz and |B| carry independent boundary information not
captured by Bx and By alone.

**P5:** CD R64 F1 will be WITHIN 0.05 of CD R32 F1 (not significantly better).
_Rationale:_ At 1-minute cadence, doubling temporal resolution via half-lag
...
| P4: CD R16 F1 < CD R32 F1                       | **CONFIRMED** | R16 F1=0.207 << R32 F1=0.601 (Bz and                              |
