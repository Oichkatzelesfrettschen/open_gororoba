...
The measured baseline is `data/output/debt_baseline_2026_06_04.toml`,
regenerated by the anchored `repo-audit` binary (comment/string-stripped
regex on Rust, line-anchored on Rocq):
