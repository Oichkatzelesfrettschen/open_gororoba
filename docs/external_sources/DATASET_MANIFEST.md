...
| Hipparcos Legacy Catalog | HipparcosProvider | CDS I/239 | DAT.GZ | ~35 MB | Open |
| TSIS-1 TSI Daily | TsisTsiProvider | LASP LISIRD | CSV | ~500 KB | Open |
| SORCE TSI Daily | SorceTsiProvider | LASP LISIRD | CSV | ~2 MB | Open |
| EHT M87 2018 Data Bundle | EhtM87Provider | EHT Collaboration GitHub | TGZ | ~250 MB | Open |
| EHT SgrA 2022 Data Bundle | EhtSgrAProvider | EHT Collaboration GitHub | TGZ | ~120 MB | Open |
...
| Union3 Legacy SN Ia | Union3Provider | DESI Y3 cobaya chains | TXT | ~15 MB | Open |
...
## Geophysical and Ephemeris Datasets
...
| GRACE-FO Gravity Field | GraceFoProvider | ICGEM GFZ | GFC | ~3 MB | Open |
| GRAIL GRGM1200B | GrailGrgm1200bProvider | ICGEM GFZ | GFC | ~84 MB | Open |
| EGM2008 Static Geoid | Egm2008Provider | NGA | GZ | ~75 MB | Open |
| Swarm L1B Magnetic Sample | SwarmMagAProvider | ESA VirES HAPI | CSV | ~1 MB | Open |
| Landsat C2 L2 STAC Metadata | LandsatStacProvider | USGS STAC | JSON | ~100 KB | Open |
| JPL DE440 Ephemeris Kernel | De440Provider | NAIF/JPL | BSP | ~120 MB | Open |
| JPL DE441 Ephemeris Kernel | De441Provider | NAIF/JPL | BSP | ~2.6 GB | Open |
...
| EHT .tgz | catalogs::eht | Compressed release bundles for M87* and Sgr A* |
...
- Olausen and Kaspi (2014), ApJS 212, 6 (McGill)
...
- van Leeuwen (2007), Hipparcos data reduction
- Kopp (2021), Sol Phys 296, 133 (TSIS-1)
- Kopp and Lean (2011), Geophys. Res. Lett. 38, L01706 (SORCE TIM)
- EHT Collaboration (2019, 2022, 2024 releases)
- Scolnic+ (2022), ApJ 938, 113 (Pantheon+)
- DESI Collaboration Y3 cosmology chains (2025)
...
- Chulliat+ (2025), WMM2025 technical report
- Ries+ (2016), GFZ Data Services (GGM05S)
- Landerer+ (2020), GRACE-FO mission and gravity recovery
- Lemoine+ (2014), JGR 119, 1698 (GRAIL)
- Pavlis+ (2012), JGR 117, B04406 (EGM2008)
- Friis-Christensen+ (2006), Earth Planets Space 58, 351 (Swarm)
- Irons+ (2024), USGS Landsat STAC services
- Park+ (2021), AJ 161, 105 (DE440/DE441)
