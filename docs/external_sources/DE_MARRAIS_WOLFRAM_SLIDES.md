# 2004 Wolfram Science Slides

**Source:** data/external/papers/de_marrais_2004_wolfram_science_slides.pdf
...
entities are not just oddballs, but unavoidable.1 (And, a little less than seven years ago,
the Mexican mathematician Guillermo Moreno2 showed more: in the 16-D imaginaries
called “Sedenions” where we're first forced to deal with them, ZD's conform to some
remarkably familiar algebraic patterns which have echoes in all higher, 2N-dimensional,
...
nonassociative operations what groups ought to do but can't!4)
...
upon the implications of certain kinds of non-observability.7 But more germane here is a
brief “blue sky” piece by Andrei Sakharov8 concerning an underlying spacetime “lattice”
...
the automorphism group of the Octonions, known in Dynkin-diagram argot as “G2”; but
...
Octonions have 7; the Quaternions, but 1; and 2N-ions in general have (2N-1)(2N-2)/(3!).)
Second, the breakdown of the “squares law” beyond the Octonions opens out on a way of
thinking surprisingly akin to renormalization: if the product of a pair of 2N-ions seems to
need the number of dimensions in which 2N+1-ions live, and if “look-alike” algebras incor-
...
clear correlation between the size of the central black hole and the galaxy itself.10 I invite
...
was an open question whether the Trip-Sync property holds for ZD patterns in all 2n-ions,
...
less “hyper” than Sedenions: for the 2N units in a given universe of 2N-ions, label their
...
predecessor 2N-ions, you affix a unit of index 2N and produce 2N-1 triplets as above. All
...
the ( o, S ) plane (one of the 7·6 = “42 Assessors”) will have all their points be ZD's.
...
dubbed “Cl2,” since it has 22 dimensions, to be precise). Its axes include the usual real
...
tors can be written thus: ½(1 + m). It's easy to show that, for each of these quantities,
...
pairing “emanates” the third: e.g., ( SA , oA ) · ( SB , oB ) = + ( SC , oC ) – ( SC , oC ) = 0) and
...
joined by an edge-sign marked “–”, will have product (K + sg·k) · (L – sg·l) = (KL – sg·Kl
+ sg·kL – kl) = 0. Since KL and kl = o's, and Kl and kL = S's, then KL = kl = m, and Kl =
kL = M, where (M, m) is the third Assessor in the Sail. If the edge-sign be “+,” then the
opposite obtains: KL = –kl = –m, so S-trip (K, L, m) has opposite sense from O-trip (k,
l, m). Since the edge-signs leading out from a Zigzag vertex in a Trefoil must be “+,” the
...
code”-level detail concerning general 2N-ion multiplication. Next, we'll probe the pheno-
...
11 = 1, but with sign reversed. Whence the S-trip at the top of the 1st column, (1, 11, 10).
By cycling according to the same logic, (3 xor 1 = 11 xor 9 = 2) → (2, 9, 11), and (1 xor 2
= 9 xor 10 = 3) → (3, 10, 9). By proceeding similarly with (1, 4, 5), rows 1 of the 2nd
...
less than the generator g = 2N, the value in cell (r, c) of the table = r·c. If one term > g (it
doesn't matter which), the index and sign of their product is just [–(2N + r·c)]. If both
terms > g, XOR-ing kills the 2N, leaving just [–r·c].
...
terms in their places, but changes the L-terms at the vertices to read this way: (3, 10, 9, 8,
...
is “–”. Such a table has blank diagonals (since Assessors never make ZD's between their
own diagonals, or with those of their strut-opposite), hence 142 – 2·14 = 168 filled-in
...
strut constants = the differences of the table's s and g-1 terms ( i.e., 1 - 7); the “repeaters,”
...
density of ZD's → 0 as N → ∞? Would that imply (and quite counterintuitively) that
...
II ® 6      1   7   15   9 14     (6, 15, 9)     (14, 7, 9)       (14,15, 1)
                                 III:ADe; IV:FCe IV:FdB;V:fDB III:FDb; V:ADe
                                 (V:ABc)         (III:ABc)       (IV:aBC)
III ® 7     2   5   13 10 15     (7,13,10)       (15,5,10)        (15,13, 2)
...
VI ® 4      7   3   11 15 12     (4,11,15)       (12,3,15)        (12,11, 7)
...
determined by 3 of them) is just 7 x 3 x 23 (the number of possible signing conventions
...
         “Stereo Fano” Synergies on Display (7 Pléiades + “Atlas”)
...
Rodrigo Obando's ongoing work13 on applying Boolean function theory to NKS systems
...
equal 2 raised to the (25 = ) 32nd power, which is more than 4 billion rules altogether –
...
this means we're dealing with the much more manageable count of 216 logical express-
...
birthday: it doesn't matter how, just that it's “less than”), then assume they both employ
the “/ ” diagonal. If the first written down is the greater, however, assume “ \ ”. Next,
...
6 Jaak Lõhmus, Eugene Paal, Leo Sorgsepp, Nonassociative Algebras in Physics (Hadronic Press: Palm Harbor FL,
   1994), p. 242.
...
11 For completeness, I list in the “Strut Table”'s second column a set of indices I call “Goto numbers” in BK1, 4 per Box-
   ...
   “Moreno counterfeits” and “automorphemes” (the latter being a name only someone overly fond of Lévi-Strauss's struc-
