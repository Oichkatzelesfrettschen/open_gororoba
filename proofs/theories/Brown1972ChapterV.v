(** * Brown1972ChapterV: sourced Chapter V exponent lane for Brown (1972).

    Source:
      R.B. Brown, "Structure of zero divisors in higher dimensional real
      Cayley-Dickson algebras".

    This file carries the Chapter V integer-power lane extracted from the
    paper-level Brown aggregator. It keeps Brown's sourced quaternion and
    octonion exponent surfaces together while reusing Chapter III / IV support
    lemmas from the split Brown files. *)
